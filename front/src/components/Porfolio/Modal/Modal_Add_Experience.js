...
import './Modal.css';
function AddExperience({ setOpenModalAEX }) {
    ...
    <div className="modalBackground">
      <div className="modalContainer">
        ...
        <div className="bodyModal">
          ...
          <input type="date" class="form__input" id="StartData" required=""
            onChange={(e) =>
              setFormData({ ...formData, DateStart: e.target.value })} />
          <label for="StartData" class="form__label"></label>
