...
function Nav(props) {
  ...
  return (
    <div className=" bg-white col-start-1 col-end-1 row-start-1 row-end-10 px-3 pt-3 rounded-lg shadow-2xl ">
      {/* logo */}
      ...
      {nav_items}
      {/* <Nav_Item leading={faSignOutAlt} title="Logout" path="/signin" /> */}
    </div>
  );
}
