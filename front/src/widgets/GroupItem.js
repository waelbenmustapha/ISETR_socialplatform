...
function deletegroup(){
 ...
 {showsett&&<div style={{width:'150px',position:'absolute',backgroundColor:'#ccc',right:'0px'}}>
   {props.mygroups?<p onClick={()=>{leavegroup();}} className='hovera' style={{color:'black',padding:'10px',textAlign:'center',fontWeight:'400'}}>Leave Group</p>:<p onClick={()=>{console.log("join group");}} className='hovera' style={{color:'black',padding:'10px',textAlign:'center',fontWeight:'400'}}>Request to join group</p>}
